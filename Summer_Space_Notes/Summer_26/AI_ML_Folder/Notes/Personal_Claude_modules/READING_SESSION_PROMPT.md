# Reusable Reading-Session Prompt (Personal Claude ML/AI Class)

Copy the block below into a new Claude Code session at the start of any reading.
Fill in the **[BRACKETED]** parts. Everything else tells Claude how to run the session.
...
> **Source:** [BOOK / COURSE NAME — e.g. Bishop, *Pattern Recognition and Machine Learning*]
> **Scope:** [SECTIONS / CHAPTERS — e.g. 1.1–1.3]
> **Week/Module:** [e.g. Week 1, Month 1]
> **Working folder:** [PATH to this session's folder, e.g. .../Week1_Bishop_1.1-1.3]
>
> Run the session like this:
> 1. Create a `<topic>_materials/` folder in the working folder for note `.md` files and images.
...
>    grad student would — concise conceptual summary, key derivations worked out, *try the exercises*,
>    and short "why this matters / intuition" remarks. Keep my captured chunks and your generated
...
- **Folder layout** (mirrors the Codecademy reading sessions):
  ...
  <Week_Folder>/
    <Topic>_materials/
      ...
      notes_02_<slug>.md
      img_<slug>.png
    <Topic>_Notes.ipynb        # built at the end, on "done"
  ```
...
- **Notebook on "done":** markdown cells carry the prose/math; code cells are runnable; images embedded.
  Should render cleanly in Jupyter and be compilable if executed top-to-bottom.
