...
and train your own nanoGPT-class model on heavy-ion abstracts (Week 27, GPU week), then
...
**Month-end deliverable:** a trained nanoGPT-class checkpoint on your heavy-ion corpus,
