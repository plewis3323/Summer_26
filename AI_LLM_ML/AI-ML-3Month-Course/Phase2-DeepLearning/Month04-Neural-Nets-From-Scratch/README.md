...
closes with a mini-project pitting an MLP against your Phase-1 BDT capstone on the
same tabular data.
...
**Month-end deliverable:** working autograd engine + PyTorch MLP on the Capstone-1
tabular data with an honest comparison against the BDT (win, or explain why not).
