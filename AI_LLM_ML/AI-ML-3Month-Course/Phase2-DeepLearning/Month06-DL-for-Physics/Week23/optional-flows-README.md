# Week 23 optional — Normalizing Flows + Fast Simulation

This file is **not** the scheduled Week 23 (that is software engineering for
services). Use it if your capstone is generative fast-sim.
...
- (Week 16) Which training pathologies should you watch for in a generator's
  decoder, and what does a tanh-clamp on a scale output prevent?
