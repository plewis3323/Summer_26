...
- [ ] W13 MLPs + backprop on paper
- [ ] W14 micrograd
- [ ] W15 PyTorch fundamentals
- [ ] W16 Training dynamics + MLP-vs-BDT mini-project
- [ ] **Month 04 sign-off**
- [ ] W17 Convolutions
...
- [ ] W33 Embeddings
- [ ] W34 RAG
- [ ] W35 Diffusion (DDPM derived)
- [ ] W36 **Capstone 3** (track chosen: ______)
- [ ] **Month 09 sign-off + Phase 3 gate** (date: ______)
...
- [ ] **Month 10 sign-off**
- [ ] W41 Experiment infrastructure
- [ ] W42 Performance engineering
- [ ] W43 Reinforcement learning (policy gradient derived)
...
## Monthly cold re-derivations (rotate, log date + pass/fail)

| Result | Attempts |
|--------|----------|
| PCA from variance maximization | |
| Backprop (2-layer + softmax/CE) | |
| VAE ELBO | |
| Scaled dot-product attention (incl. √d) | |
